...
keytool -genkey -v -keystore com.nfctouch.whospets.aos.keystore -alias com.nfctouch.whospets.aos -keyalg RSA -keysize 2048 -validity 10000
...
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore com.nfctouch.whospets.aos.keystore platforms/android/app/build/outputs/apk/release/app-release-unsigned.apk com.nfctouch.whospets.aos

cd D:\GitHub\whospets\platforms\android\app\build\outputs\apk\release
zipalign -v 4 app-release-unsigned.apk whospets.apk
--joanne
